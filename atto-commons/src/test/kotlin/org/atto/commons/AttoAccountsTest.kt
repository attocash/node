...
internal class AttoAccountsTest {
    private val seed = AttoSeed("1234567890123456789012345678901234567890123456789012345678901234".fromHexToByteArray())
    private val expectedAccount = AttoAccount("atto_3iwi45me3cgo9aza9wx5f7rder37hw11xtc1ek8psqxw5oxb8cujzue6p7nc")
    ...
    fun `should create account`() {
        ...
        // when
        val account = publicKey.toAccount()
    ...
    fun `should public key from account when hex starts with zero`() {
        ...
        // when
        val publicKey = expectedPublicKey.toAccount().toPublicKey()
    ...
    fun `should extract address to public key`() {
        ...
        // then
        assertEquals(expectedAccount, publicKey.toAccount())
    }
