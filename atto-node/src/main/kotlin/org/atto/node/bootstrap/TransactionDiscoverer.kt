...
//            if (event.rejectionReason == TransactionRejectionReason.SEND_NOT_FOUND) {
//                findSingle(transaction.hash)
//            } else if (event.rejectionReason == TransactionRejectionReason.ACCOUNT_NOT_FOUND) {
//                findMultiple(transaction, 0u, transaction.block.height)
//            } else if (event.rejectionReason == TransactionRejectionReason.PREVIOUS_NOT_FOUND) {
...
//            range,
//            onReceive = {
//                eventPublisher.publish(AttoTransactionVoted(it, null))
//            },
//            onExpire = {
//                findSingle(hash)
...
//        if (transaction.block !is PreviousSupport) {
//            throw IllegalArgumentException("Find multiple should be called with PreviousSupport block")
//        }
//
//        val peer = peerHolder.get()
//        val range = MultipleTransactionRage(transaction.block, startHeight, endHeight)
//
//        val job = DiscoveryJob(
//            range,
//            onReceive = {
...
//    }
//
//    class MultipleTransactionRage<T>(
//        block: T,
//        private val startHeight: ULong,
//        private val endHeight: ULong
//    ) : TransactionMonitor where T : AttoBlock, T : PreviousSupport {
//        private val publicKey = block.publicKey
//
//        @Volatile
//        private var previous = block.previous
//
//        override fun hasNext(): Boolean {
