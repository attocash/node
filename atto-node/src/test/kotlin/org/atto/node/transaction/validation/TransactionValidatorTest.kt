...
//                thisNode.socketAddress,
//                this,
//                AttoTransactionPush(sendTransactionA)
//            )
//        )
//
//        verify(exactly = 1, timeout = defaultTimeout) {
...
//                thisNode.socketAddress,
//                this,
//                AttoTransactionPush(changeTransactionA)
//            )
//        )
//
...
//                thisNode.socketAddress,
//                this,
//                AttoTransactionPush(receiveTransactionB)
//            )
//        )
//
//        verify(exactly = 0, timeout = defaultTimeout) {
...
//
//        checkInvalid(TransactionRejectionReason.INVALID_TRANSACTION, openBlockA, listOf())
//    }
//
//    @Test
...
//
//        checkInvalid(TransactionRejectionReason.SEND_NOT_FOUND, openBlockA, listOf())
//    }
//
//    @Test
...
//        val receiveBlockB = existingOpenBlockB.receive(existingSendBlockA)
//
//        checkInvalid(TransactionRejectionReason.SEND_NOT_FOUND, receiveBlockB, listOf(existingOpenBlockB))
//    }
//
//    @Test
...
//
//        checkInvalid(TransactionRejectionReason.INVALID_SEND, openBlockB, listOf(existingOpenBlockA))
//    }
//
//    @Test
...
//
//        checkInvalid(
//            TransactionRejectionReason.INVALID_SEND,
//            receiveBlockB,
...
//
//        checkInvalid(TransactionRejectionReason.INVALID_AMOUNT, openBlockB, listOf(existingSendBlockA))
//    }
//
//    @Test
...
//
//        checkInvalid(TransactionRejectionReason.INVALID_TIMESTAMP, openBlockB, listOf(existingSendBlockA))
//    }
//
//    @Test
...
//
//        checkInvalid(TransactionRejectionReason.INVALID_VERSION, openBlockB, listOf(existingSendBlockA))
//    }
//
//    @Test
...
//
//        checkInvalid(
//            TransactionRejectionReason.SEND_NOT_CONFIRMED,
//            receiveBlock,
//            emptyList(),
...
//
//        checkInvalid(
//            TransactionRejectionReason.ACCOUNT_NOT_FOUND,
//            sendBlock,
//            listOf()
//        )
//    }
...
//
//        checkInvalid(
//            TransactionRejectionReason.PREVIOUS_NOT_CONFIRMED,
//            sendBlock,
//            listOf(),
//            listOf(existingOpenBlockA)
//        )
...
//
//        checkInvalid(
//            TransactionRejectionReason.INVALID_CHANGE,
//            changeBlock,
//            listOf(existingOpenBlockA)
//        )
//    }
...
//
//        checkInvalid(
//            TransactionRejectionReason.SEND_ALREADY_USED,
//            receiveBlockB,
...
//                thisNode.socketAddress,
//                this,
//                AttoTransactionPush(receivedTransaction)
//            )
//        )
//
//        // then
